...
Cobra root command and CLI entry point for MirageNet
...
func newRootCmd() *cobra.Command {
	root := &cobra.Command{
		Use:   "mirage",
		Short: "Multi-service deception network",
		Long: `MirageNet deploys a network of realistic honeypots (SSH, HTTP, FTP,
...
func newVersionCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			fmt.Printf("  Module:   github.com/CarterPerez-dev/miragenet\n")
		},
	}
}
